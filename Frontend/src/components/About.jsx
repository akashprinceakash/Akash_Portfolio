...
import aboutimage from "../assets/PicsArt_01-24-11.00.55.png";
  ...
  return (
    ...
    >
      <div className="text-3xl flex flex-col w-full sm:w-1/3  ">
        ...
        <p className="text-2xl  mt-5 line-clamp-3  drop-shadow-custom1">
        ...
        <button className="mt-3 font-satisfy text-lg transition duration-100 ease-in-out hover:scale-110 hover:bg-indigo-900 w-40 rounded-lg border-2 text-white ">
          <a href="#" className="">
          Read more
          </a>
        </button>
